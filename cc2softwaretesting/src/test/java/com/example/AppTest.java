...
public class AppTest 
{
    ...
    public void setup() {
        ...
        ExtentSparkReporter spark = new ExtentSparkReporter(
                "C:\\Users\\91701\\Desktop\\cc2softwaretesting\\report.html");
    ...
    public void testCase2() throws InterruptedException {
        ...
        Thread.sleep(3000);
        driver.findElement(By.xpath("//*[@id=\"prodInfoContainer\"]/div[3]/form[1]/input[10]"));
        Thread.sleep(2000);
        String res = driver.switchTo().alert().getText();
        if(res.contains("Add to cart")) {
            logger.info("Successfully added to cart");
        }
        else {
            logger.info("Not added to cart");
        }
    }
    @Test(priority = 2)
